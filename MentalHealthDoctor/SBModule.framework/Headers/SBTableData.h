...
/** 前一页的class */
@property (nonatomic, assign) Class<SBTableViewCellDelegate>   mPreviousPageCellClass;
...
@property (nonatomic, assign) SBTableDataStatus SBTableDataStatus;      //状态
...
@property (nonatomic, assign) BOOL hasSeparatorInset;                   //单元格分割线是否空一段距离 默认 yes
...
@property (nonatomic, strong) UIColor *cellBackgroundColor;              //单元格背景色
@property (nonatomic, strong) UIColor *selectedBackgroundColor;              //单元格点击色
@property (nonatomic, strong) UIColor *loadingBackgroundColor;              //单元格加载色
