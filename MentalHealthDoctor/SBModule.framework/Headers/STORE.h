...
#define STORE_CORE_STOCK_FRAMEWORK_CONFIG    @"STORE_CORE_STOCK_FRAMEWORK_CONFIG"   // 股吧库配置
#define STORE_CORE_NEWS_ISREAD              @"STORE_CORE_NEWS_ISREAD"   // 资讯是否已经阅读
#define STORE_CORE_PDF_DOWN              @"STORE_CORE_PDF_DOWN"   //下载PDF
#define STORE_CORE_NEWS_CONFIG              @"STORE_CORE_NEWS_CONFIG"   // 资讯配置
#define STORE_CORE_PORTFOLIO_OPTION_CONFIG              @"STORE_CORE_PORTFOLIO_OPTION_CONFIG"   // 投资组合选项配置
