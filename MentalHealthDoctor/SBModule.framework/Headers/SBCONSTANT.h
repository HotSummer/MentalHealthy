...
//其他常用ui
#import "SBBarButtonItem.h"          //导航条item
...
#define APPCONFIG_UI_BUTTON_MHEIGHT         30.0f                       // 中等大小的按钮的高度
#define APPCONFIG_UI_BUTTON_MWIDTH          92.0f                       // 中等大小的按钮的宽度
#define APPCONFIG_UI_BUTTON_FHEIGHT         40.0f                       // 中等大小的按钮的高度
#define APPCONFIG_UI_BUTTON_FWIDTH          300.0f                      // 中等大小的按钮的宽度
...
#define __SB_REMIND_LOADINGFAIL @"数据加载出错，点击可重试!"
