 ...
 *
 */
+(SBHttpDataLoader *)sbget_Custom_gubaCount:(NSString *)code delegate:(id<SBHttpDataLoaderDelegate>)delegate;
 ...
 *  @param p        页码
 */
+ (SBHttpDataLoader *)sbget_follow_users_articles:(NSInteger)p
                                  delegate:(id<SBHttpDataLoaderDelegate>)delegate;
/**
 *  关注的股，热帖列表
 *
...
+ (SBHttpDataLoader *)sbset_articleReply_status:(NSString *)postId
                                         huifuId:(NSString *)hid
                                            text:(NSString *)text
                                        isRepost:(BOOL)isRepost
                                          t_type:(SBV3AritlceType)replyType
                                        delegate:(id<SBHttpDataLoaderDelegate>)delegate;
