...
typedef NS_ENUM(NSInteger, SBV3StockbarType){
    ...
    /** 指数 */
    SBV3StockbarTypeIndex = 102,
    /** 板块*/
    SBV3StockbarTypePlate = 103,
    /** 基金*/
    SBV3StockbarTypeFund = 105,
    /** 未上市*/
    SBV3StockbarTypeUnUP = 200,
    /** 主题吧*/
    SBV3StockbarTypeTheme = 201,
//    /** 导入的吧*/
//    SBV3StockbarTypeChannel = 202,
//    /** 基金公司*/
//    SBV3StockbarTypeFundCompany = 203,暂未用到
    /** 期权吧*/
 ...
 *  股吧帖子的类型
 */
typedef NS_ENUM(NSInteger, SBV3AritlceType){
    /** 全部 */
    SBV3AritlceTypeAll = 0,
    /** 新闻*/
    SBV3AritlceTypeNews = 1,
    /** 研报*/
    SBV3AritlceTypeSurvey = 2,
    /** 公告 */
    SBV3AritlceTypeAnnounce = 3,
    /**  数据*/
    SBV3AritlceTypeData = 4,
    /**  股东会*/
    SBV3AritlceTypeShareHolder = 5,
    /**  博客*/
    SBV3AritlceTypeBlog = 7,
    /**  访谈*/
    SBV3AritlceTypeInterview = 8,
    /**  投资组合*/
    SBV3AritlceTypePortfolio = 9,
    
    /**  投票帖*/
    SBV3AritlceTypeVotePost = 10,
    /**  热门 这个是自定义的*/
    SBV3AritlceTypeHot = 99
};
 ...
 *  股吧帖子的类型 新闻摘要
 */
typedef NS_ENUM(NSInteger, SBV3AritlceSpecialType){
    /** 新闻*/
    SBV3AritlceSpecialTypeNews = 0,
    /** 摘要 */
    SBV3AritlceSpecialTypeSummay = 1,
    /** 其他 */
    SBV3AritlceSpecialTypeOther = 99,
};
...
#define JNV3_POST_POST_TYPE               @"post_type"                   //类型（0：普通，1：新闻，2：研报，3：公告，4：数据）,
